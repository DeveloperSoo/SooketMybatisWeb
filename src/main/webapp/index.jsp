    ...
    <div id="container">
        ...
        <main id="main">
            <section id="healing">
                <article>
                    <h2>몸과 마음이 치유되는 섬</h2>    
                    <img src="../resources/images/healing.png" alt="healing">
            ...
            <section id="activity">
                    <article>
                        ...
                        <img src="../resources/images/activity.png" alt="healing">
                        <p><b>모험과 스릴이 넘치는 레저의 천국으로 안내합니다.</b></p>
                        <p>둘러보기만 한 여행을 하셨나요?</p>
                        <p>
                            하늘을 날며 시원한 바다를 내려다보는 패러글라이딩과
                            투명한 물빛 속을 여행하는 스쿠버다이빙.. 아름다운 제주 해안도로를
                            씽씽 전동바이크나 전동 킥보드로 달려보세요, 시원한 바다를 가까이에서
