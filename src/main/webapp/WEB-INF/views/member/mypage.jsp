						...
						<form action="/member/update" method="post">
							...
							<div class="info-group">
								...
								<div class="radio-group">
									<label>
										<input type="radio" disabled <c:if test = "${requestScope.member.gender eq 'M'}">checked</c:if>>
										남																
									</label>
									<label>
										<input type="radio" disabled <c:if test = "${requestScope.member.gender == 'F'}">checked</c:if> >
										여														
									</label>
								</div>			
							</div>	
